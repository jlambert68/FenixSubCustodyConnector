...
require (
	...
	github.com/jlambert68/FenixConnectorAdminShared v0.0.0-20250610072223-f815102cffd7
	github.com/jlambert68/FenixGrpcApi v0.0.0-20250610060949-429dbba91f65
